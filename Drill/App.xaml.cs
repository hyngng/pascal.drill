using Drill.Activation;
using Drill.Contracts.Services;
using Drill.Core.Contracts.Services;
using Drill.Core.Services;
using Drill.Helpers;
using Drill.Models;
using Drill.Notifications;
using Drill.Services;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<웹보기ViewModel>();
            services.AddTransient<웹보기Page>();
